...
| Understand the moving parts | [Services overview](services/index.md) |
...
| Run models on your own GPUs | [Model server](model-server/index.md) |
| Connect something to VoicEra | [Connecting a client](clients/index.md) |
...
* [**Overview**](services/index.md) — containers, ports, start-up order, who talks to whom
...
* [**Model server**](model-server/index.md) — the section index
...
* [**Contributing**](guides/contributing-guide.md) — branches, commits, pull requests
...
<Note>
The Next.js dashboard is part of the Compose stack, on port 3000. Its container runs the Next.js development server, so build it properly before exposing it. See [Dashboard](frontend/index.md).
</Note>
