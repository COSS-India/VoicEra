...
#
#   curl -fsSL https://raw.githubusercontent.com/PRANABraight/voicera_mono_repository/dev-doc/scripts/install.sh | bash
set -euo pipefail

REPO="PRANABraight/voicera_mono_repository"
BRANCH="${VOICERA_BRANCH:-dev-doc}"
